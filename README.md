# Java. Базовый курс
Это курс, расположенный на платформе [stepik.org](https://stepik.org)

Задача [отсюда](https://stepik.org/lesson/12783/step/8?unit=3130)
...
Cn+1=rotateLeft(Cn) xor bn+1, где Cn — контрольная сумма первых n байт данных, rotateLeft — циклический сдвиг бит числа на один бит влево (чтобы не изобретать велосипед, используйте Integer.rotateLeft), 
